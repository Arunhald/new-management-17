...
class Config(object):
    ...
    DB_URI = getenv("DATABASE_URL", "mongodb+srv://Arunkumar:arunhald@cluster0.n5oxsxc.mongodb.net/?retryWrites=true&w=majority")
    MESSAGE_DUMP = getenv("MESSAGE_DUMP", "-1001645899463")
    GBAN_LOGS = getenv("GBAN_LOGS", "-1001645899463")
    SYS_ADMIN = getenv("SYS_ADMIN", "1398015365")
    DEV_USERS = getenv("DEV_USERS", "1398015365")
    LOAD = getenv("LOAD")
    WEBHOOK = False
    SPB_MODE = True
    DROP_UPDATES = False
    ...
    SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1398015365").split()))
    ZAID_USER = list(map(int, getenv("DEV_USERS", "1398015365").split()))
